...
TESTDATA = { 
    ...
    'reference_indicators':"file://{0}".format(os.path.join(TESTS_HOME, 'testdata', 'spatial_analog', 'reference_indicators.nc')),
    'target_indicators': "file://{0}".format(os.path.join(TESTS_HOME, 'testdata', 'spatial_analog', 'target_indicators.json'))
    }
